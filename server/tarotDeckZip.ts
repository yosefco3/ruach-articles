...
function readmeText(): string {
  return [
    "חפיסת הטארוט של רוח חכמה — The Ruach Wisdom Tarot Deck",
    "========================================",
    "",
    ...
    "בכל פרסום או שימוש פומבי יש לציין את רוח חכמה (ruachwisdom.org) כמקור",
    "ולצרף קישור פעיל לאתר: https://ruachwisdom.org/tarot",
    "(ברוח רישיון CC BY 4.0).",
    "",
    "---",
    "",
    "The Ruach Wisdom Tarot Deck — 78 cards + back, originally painted for",
    ...
    "any public use must credit Ruach Wisdom (ruachwisdom.org) as the source and",
