  ...
  return (
    ...
    >
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "56px 24px 96px" }}>
        ...
        <h3 style={H3_STYLE}>שאלת בחירה? פריסת "שתי הדרכים"</h3>
        <p style={P_STYLE}>
          כשהשאלה היא הכרעה בין אפשרויות מפורשות — "לעבור לתל אביב או להישאר
          בירושלים?", "איזה מסלול לבחור?" — שלושה קלפים לא מספיקים, כי צריך להשוות.
          לכך מתאימה פריסת בחירה: קלף <strong>הצומת</strong> מתאר מאיזה מקום בוחרים;
          לכל דרך שני קלפים באותם תפקידים — <strong>מה היא מציעה</strong> (הצד הגלוי,
          מה מושך) ו<strong>לאן היא מובילה</strong> (התוצאה הסבירה, כולל המחיר) — כך
          שההשוואה היא תמיד תפקיד מול תפקיד; וקלף סוגר, <strong>מה שאינך רואה</strong>,
          מביא עצה, גורם נסתר, או דרך שלישית שלא עלתה בשאלה. לשתי אפשרויות זו "פריסת
          שתי הדרכים" (שישה קלפים); לשלוש או ארבע — "מניפה". הקלפים מתארים לאן הדברים
          נוטים; ההכרעה נשארת אצל השואל.
        </p>
        <p style={P_STYLE}>
          באתר, למשתמש מחובר שפירוש ה-AI זמין לו, ה-AI מזהה בעצמו שאלת בחירה ופורס
          את הפריסה המתאימה במקום שלושת הקלפים — ומפרש אותה בשיטת ההשוואה. בלי AI,
          הקריאה היא תמיד שלושה קלפים.
        </p>
        <p style={P_STYLE}>
          אפשר להתנסות מיד:{" "}
          <Link href="/tarot" style={LINK_STYLE}>שליפת קלפים אונליין</Link> —
