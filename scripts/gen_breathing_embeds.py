...
<h4>לנקבה</h4>
<p>תנועת הידיים זהה:</p>
<ol>
<li>התחילי כשהידיים סמוך לבטן התחתונה ולאזור המין — ושם <b>אספי את האנרגיה</b>.</li>
<li>הניעי את הידיים באלכסון כלפי מעלה, עד גובה החזה. בזמן התנועה — <b>שאיפה</b>.</li>
<li>קרבי את הידיים לחזה.</li>
<li>הפכי את תנועת הידיים לדחיפה אלכסונית כלפי מטה, עד גובה הבטן התחתונה ואזור המין.
בזמן התנועה — <b>נשיפה</b>.</li>
<li>קרבי את הידיים לבטן התחתונה, אספי את האנרגיה — וחוזר חלילה.</li>
</ol>

<div class="b8-rule">
<p>בשני המינים הידיים <b>עולות בשאיפה ויורדות בנשיפה</b>. ההבדל ביניהם אינו בגובה אלא
בעומק — באיזה אלכסון עוברת התנועה:</p>
<p>אצל הזכר השאיפה נעה מ<b>הישבן</b> אל <b>החזה</b>, ואצל הנקבה מ<b>אזור המין</b> אל
<b>הגב</b>. שניהם קו המינוס — שקוע אל שקוע. תנועת הידיים אינה יכולה להראות את ציר
העומק, ולכן היא נראית זהה; ההבדל נמצא בפנים, ובדיאגרמות אפשר לראות אותו.</p>
</div>
