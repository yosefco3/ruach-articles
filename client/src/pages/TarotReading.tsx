...
const CHOOSE_SPREAD_TIMEOUT_MS = 20000;
...
export default function TarotReading() {
  ...
  // שחזור פריסה שנשמרה לפני התחברות גוגל (returnTo מחזיר לכאן) — פעם אחת בעלייה.
  useEffect(() => {
   ...
   * את הפריסה מהקטלוג. Fail-open: שגיאה / איטיות מעל 20 שניות (המודל חושב ~3-9ש') → שלושה קלפים.
   */
  ...
  return (
    ...
    >
      ...
      <p style={{ maxWidth: 520, margin: "12px auto 20px", fontSize: 15.5, lineHeight: 1.9, color: "oklch(0.40 0.03 58)" }}>
        ...
        , להוריד, להדפיס ולהשתמש באופן חופשי — בתנאי ייחוס לרוח חכמה וצירוף
